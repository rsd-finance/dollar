...
const INITIAL_STAKE_MULTIPLE = new BN(10).pow(new BN(6)); // 100 RSD -> 100M RSDS
...
describe('Pool', function () {
  ...
  beforeEach(async function () {
    ...
    this.dollar = await MockToken.new("Real Stable Dollar", "ESD", 18, {from: ownerAddress, gas: 8000000});
