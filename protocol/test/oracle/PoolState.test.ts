...
import MockPoolStateArtifact from "../../artifacts/contracts/mock/MockPoolState.sol/MockPoolState.json";
import { MockPoolState } from "../../typechain/MockPoolState";
...
describe("PollState", function () {
  ...
  beforeEach(async function () {
    ...
    setters = (await deployContract(owner, MockPoolStateArtifact, [])) as MockPoolState;
