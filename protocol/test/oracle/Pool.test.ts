...
import MockPoolArtifact from "../../artifacts/contracts/mock/MockPool.sol/MockPool.json";
import { MockPool } from "../../typechain/MockPool";

import MockTokenArtifact from "../../artifacts/contracts/mock/MockToken.sol/MockToken.json";
import { MockToken } from "../../typechain/MockToken";

import MockUniswapV2PairLiquidityArtifact from "../../artifacts/contracts/mock/MockUniswapV2PairLiquidity.sol/MockUniswapV2PairLiquidity.json";
import { MockUniswapV2PairLiquidity } from "../../typechain/MockUniswapV2PairLiquidity";

import MockSettableDAOArtifact from "../../artifacts/contracts/mock/MockSettableDAO.sol/MockSettableDAO.json";
import { MockSettableDAO } from "../../typechain/MockSettableDAO";
...
describe("Pool", function () {
  ...
  beforeEach(async function () {
    dao = (await deployContract(owner, MockSettableDAOArtifact, [])) as MockSettableDAO;
    await dao.set(1);
    dollar = (await deployContract(owner, MockTokenArtifact, ["Real Stable Dollar", "RSD", 18])) as MockToken;
    usdc = (await deployContract(owner, MockTokenArtifact, ["USD//C", "USDC", 18])) as MockToken;
    univ2 = (await deployContract(owner, MockUniswapV2PairLiquidityArtifact, [])) as MockUniswapV2PairLiquidity;
    pool = (await deployContract(owner, MockPoolArtifact, [usdc.address])) as MockPool;
