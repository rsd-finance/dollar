...
import MockGovernArtifact from "../../artifacts/contracts/mock/MockGovern.sol/MockGovern.json";
...
import { MockGovern } from "../../typechain/MockGovern";
...
describe("Govern", function () {
  ...
  beforeEach(async function () {
    govern = (await deployContract(owner, MockGovernArtifact, [])) as MockGovern;
