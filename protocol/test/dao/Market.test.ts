...
import MockMarketArtifact from "../../artifacts/contracts/mock/MockMarket.sol/MockMarket.json";
import { MockMarket } from "../../typechain/MockMarket";
...
describe("Market", function () {
  ...
  beforeEach(async function () {
    market = (await deployContract(owner, MockMarketArtifact, [pool.address])) as MockMarket;
