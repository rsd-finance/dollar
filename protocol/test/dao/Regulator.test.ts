...
import MockSettableOracleArtifact from "../../artifacts/contracts/mock/MockSettableOracle.sol/MockSettableOracle.json";
...
describe("Regulator", function () {
  ...
  beforeEach(async function () {
    oracle = (await deployContract(owner, MockSettableOracleArtifact, [])) as MockSettableOracle;
    regulator = (await deployContract(owner, MockRegulatorArtifact, [oracle.address, pool.address])) as MockRegulator;
